...
Field definitions specify the expected shape and behavior of your content. They tell Wesjet how to parse each property in a content object into data that your application can use.
