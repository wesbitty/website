...
import { arraysAreEqual } from '../../wesbitty/utils/helpers'
...
const content: Content = {
  heading: 'Give Wesjet a try – right here',
  steps: [
    {
      ...
      hints: {
        ...
        console: 'Wesjet runs as part of the Next.js dev server',
      },
    },
    {
    ...
    },
    {
      ...
      hints: {
        editor: 'The Wesjet config contains your document type definitions',
        ...
        <Card shadow dark>
          ...
          <div className="overflow-hidden">
            <StackblitzIDE
              ...
              repoSlug="wesbitty/wesjet-starter"
