...
After installing Contentlayer via `npm install contentlayer wesjet-nextjs-plugin` you're ready to go:
...
<div className="my-24 xl:-mx-40">
  <Playground githubRepo="wesbitty/wesjet-starter" openFile="posts/change-me.md" />
</div>
