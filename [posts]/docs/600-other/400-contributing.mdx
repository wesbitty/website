...
For feedback and general conversation, [join our Discord community](https://discord.gg/rytFErsARm). To report bugs, [open an issue on GitHub](https://github.com/wesbitty/wesbitty/issues/new).

## Providing Support

As Contentlayer's usage grows, we'll need help keeping up with [issues on GitHub](https://github.com/wesbitty/wesbitty/issues). We welcome community members helping to confirm bug reports, while also adding their use cases and perspectives to feature requests.
...
If you're interested in contributing code, please either [open an issue](https://github.com/wesbitty/wesbitty/issues/new) or find an issue on which you'd like to work. Add a comment stating that you'd like to work on resolving the issue, and we'll make a plan together, as the codebase is complex.
