...
Contentlayer does not currently support image processing, though we're [planning on implementing it](https://github.com/wesbitty/wesbitty/issues/11). Until then, there are a few different approaches you can take to working with images when your content is processed by Contentlayer:
