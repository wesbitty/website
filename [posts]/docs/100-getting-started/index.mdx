...
```txt
npm install contentlayer wesjet-nextjs-plugin
```

To hook Contentlayer into the `next dev` and `next build` processes, you'll want to wrap the Next.js configuration using the `withWesjet` method.
