...
const tweets: TweetData[] = [
  ...
  {
    text: `Been using Wesjet as the mdx processor for the Rainbow docs. Such a pleasant experience 🧘‍♂️
...
It transforms the mdx files, validates them AND adds types!`,
  ...
  {
    text: `Wesjet looks like a super promising library [...] to import data from CMS platforms or local files like markdown into your application.
...
Took me less than 5 minutes to cleanly separate and connect MDX files to a Next.js layout.`,
  ...
  {
    text: `We're using Wesjet on the @GraphCMS documentation, and it's fantastic! It not only loads all the local content, but it also supports MDX. Plus, having type definitions for the content is super helpful.`,
    person: {
