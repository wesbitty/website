...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <Card title="Try it Now" icon="gitpod" link={{url: 'http://gitpod.io/#https://github.com/wesbitty/wesjet-starter', label: 'Try in Gitpod'}}>
    If you'd like to dive right in and start playing with Wesjet, you can open the project in Gitpod.

  </Card>
  <Card title="Example Project" icon="github" link={{url: 'https://github.com/wesbitty/wesjet-starter', label: 'See example'}}>
    You can find a working version of this tutorial in [this state](https://github.com/wesbitty/wesjet-starter/tree/bca4b7884f5cad8963e631a2f24a19200c106495) of the example project.
...
Wesjet generates files in the `.wesjet/jetpack` directory. This tells JavaScript (or TypeScript) to create an alias of `wesjet/jetpack` to the generated files directory.
...
export default function Home({ posts }) {
  return (
    <div className="mx-auto max-w-2xl py-16 text-center">
      ...
      <h1 className="mb-8 text-3xl font-bold">Latest Article Example</h1>
...
- Check out [the examples](/studio) for inspiration on what you can do with Wesjet.
- Explore [local file source guides](/docs/maker/files) for learning about specific techniques.
